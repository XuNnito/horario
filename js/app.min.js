...
const CAREER_ICON_BASE_PATH = '../image';
const DEFAULT_CAREER_ICON_SRC = `${CAREER_ICON_BASE_PATH}..image/biomedica.png`;

const BASE_CAREER_OPTIONS = [
    { id: 'biomedica',        name: 'Biomédica',           icon: `${CAREER_ICON_BASE_PATH}/biomedica.png`,        fallbackIcon: `${CAREER_ICON_BASE_PATH}/biomedica.png` },
    { id: 'mecatronica',      name: 'Mecatrónica',         icon: `${CAREER_ICON_BASE_PATH}/meca.png`,             fallbackIcon: `${CAREER_ICON_BASE_PATH}/meca.png` },
    { id: 'ambiental',        name: 'Ambiental',           icon: `${CAREER_ICON_BASE_PATH}/ambiental.png`,        fallbackIcon: `${CAREER_ICON_BASE_PATH}/ambiental.png` },
    { id: 'manufactura',      name: 'Manufactura',         icon: `${CAREER_ICON_BASE_PATH}/manu.png`,             fallbackIcon: `${CAREER_ICON_BASE_PATH}/manu.png` },
    { id: 'software',         name: 'Software',            icon: `${CAREER_ICON_BASE_PATH}/sofware.png`,          fallbackIcon: `${CAREER_ICON_BASE_PATH}/sofware.png` },
    { id: 'industrial',       name: 'Industrial',          icon: `${CAREER_ICON_BASE_PATH}/industrial.png`,       fallbackIcon: `${CAREER_ICON_BASE_PATH}/industrial.png` },
    { id: 'petrolera',        name: 'Petrolera',           icon: `${CAREER_ICON_BASE_PATH}/petro.png`,            fallbackIcon: `${CAREER_ICON_BASE_PATH}/petro.png` },
    { id: 'nanotecnologia',   name: 'Nanotecnologia',      icon: `${CAREER_ICON_BASE_PATH}/nano.png`,             fallbackIcon: `${CAREER_ICON_BASE_PATH}/nano.png` },
    { id: 'robotica',         name: 'Robótica',            icon: `${CAREER_ICON_BASE_PATH}/robotica.png`,         fallbackIcon: `${CAREER_ICON_BASE_PATH}/robotica.png` },
    { id: 'alimentos',        name: 'Alimentos',           icon: `${CAREER_ICON_BASE_PATH}/alimentos.png`,        fallbackIcon: `${CAREER_ICON_BASE_PATH}/alimentos.png` },
    { id: 'gestionempresarial', name: 'Gestión Empresarial', icon: `${CAREER_ICON_BASE_PATH}/gestionempresarial.png`, fallbackIcon: `${CAREER_ICON_BASE_PATH}/gestionempresarial.png` },
];
