...
document.addEventListener('DOMContentLoaded', function () {
    ...
    input.addEventListener('keypress', function (e) {
       ...
       (function () {
            ...
            var msg = window.location.href + 'Hola, tengo un problema con mi horario en la página Horarios Bio';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Primero el enlace y luego el mensaje
    var waMessage = encodeURIComponent(shareUrl + ' ' + shareText);
