...
function addSubjectToSchedule(id) {
    ...
    // Sincronizar siempre en Drive (interactivo). Si el token expiró o no hay sesión,
    // se solicitará inicio de sesión y luego se intentará guardar.
    (async () => {
...
function removeFromSchedule(id) {
    ...
    if (index !== -1) {
        ...
        // Sincronizar siempre en Drive (interactivo) al quitar materias.
        (async () => {
            const ok = await ensureSaveToDrive({
                interactive: true,
                showSuccess: false,
