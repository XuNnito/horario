...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Mostrar el mensaje al entrar a la página
    banner.classList.remove('hidden');
    ...
    if (shareBtn) {
        // Mostrar al pasar el mouse por el botón de compartir
        ...
        // Ocultar al salir el mouse
        shareBtn.addEventListener('mouseleave', function () {
            banner.classList.add('hidden');
        });

        // También para accesibilidad con teclado
