...
async function fetchGoogleProfile() {
    ...
    try {
        ...
        try {
            ...
            localStorage.setItem('google_signed_in', '1');
            // Registrar un evento de login en el backend (se hace una vez por correo y navegador)
            if (gUserProfile && gUserProfile.email) {
                var loginKey = 'login_tracked_' + gUserProfile.email;
...
function onProfileLoaded() {
    ...
    // Registrar login en el backend (protegiendo contra duplicados por navegador/correo)
    try {
        if (gUserProfile && gUserProfile.email && typeof trackEventOnBackend === 'function') {
            var loginKey = 'login_tracked_' + gUserProfile.email;
            if (!localStorage.getItem(loginKey)) {
                trackEventOnBackend('login', {
                    name: gUserProfile.name || null,
...
(function () {
  ...
  const estiloTexto = "font-size:18px;color:black;";
...
// ================== TRACKING BÁSICO HACIA EL BACKEND (/track) ==================
